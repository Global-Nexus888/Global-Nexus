...
const content: Record<Lang, {
  ...
  es: {
    ...
    steps_producer: [
      ...
      { icon: '🚢', title: 'Coordina tu logística de exportación', desc: 'Usa nuestras herramientas de documentación TLCUEM y conecta con socios logísticos desde Puerto Veracruz hacia destinos europeos.' },
    ],
    steps_buyer: [
      ...
      { icon: '📄', title: 'Documentación simplificada', desc: 'Accede a guías, plantillas y herramientas para trámites de importación, aranceles cero TLCUEM y permisos fitosanitarios.' },
  ...
  en: {
    ...
    steps_producer: [
      ...
      { icon: '🚢', title: 'Coordinate your export logistics', desc: 'Use our TLCUEM documentation tools and connect with logistics partners from Veracruz Port to European destinations.' },
    ],
    steps_buyer: [
      ...
      { icon: '📄', title: 'Simplified documentation', desc: 'Access guides, templates and tools for import procedures, TLCUEM zero tariffs and phytosanitary permits.' },
  ...
  nl: {
    ...
    steps_producer: [
      ...
      { icon: '🚢', title: 'Coördineer uw exportlogistiek', desc: 'Gebruik onze TLCUEM-documentatietools en verbind met logistieke partners vanuit de haven van Veracruz naar Europese bestemmingen.' },
    ],
    steps_buyer: [
      ...
      { icon: '📄', title: 'Vereenvoudigde documentatie', desc: 'Toegang tot gidsen, sjablonen en tools voor importprocedures, TLCUEM-nultarieven en fytosanitaire vergunningen.' },
  ...
  de: {
    ...
    steps_producer: [
      ...
      { icon: '🚢', title: 'Koordinieren Sie Ihre Exportlogistik', desc: 'Nutzen Sie unsere TLCUEM-Dokumentationstools und verbinden Sie sich mit Logistikpartnern vom Hafen Veracruz zu europäischen Zielen.' },
    ],
    steps_buyer: [
      ...
      { icon: '📄', title: 'Vereinfachte Dokumentation', desc: 'Zugang zu Leitfäden, Vorlagen und Tools für Importverfahren, TLCUEM-Nullzölle und pflanzenschutzrechtliche Genehmigungen.' },
