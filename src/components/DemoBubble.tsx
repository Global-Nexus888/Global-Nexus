...
const COPY: Record<string, {
  ...
  es: {
    ...
    benefit1: '✓ Perfil activo desde el lanzamiento (3 Sep)',
  ...
  en: {
    ...
    benefit1: '✓ Active profile from launch day (Sep 3)',
  ...
  nl: {
    ...
    sub: 'Ontdek geverifieerde Mexicaanse producenten klaar voor export naar Europa. Registreer gratis en krijg direct toegang vanaf de lancering (3 sep).',
  ...
  de: {
    ...
    sub: 'Entdecken Sie verifizierte mexikanische Produzenten, bereit für den EU-Export. Kostenlos registrieren und ab Launch (3. Sep) direkt loslegen.',
