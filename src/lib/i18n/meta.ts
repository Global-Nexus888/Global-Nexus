...
export const pageMeta: Record<string, Record<Lang, { title: string; description: string; keywords: string }>> = {
  ...
  '/registro': {
    es: { title: 'Crear Cuenta Gratis — Global Nexus B2B México–Europa', description: 'Regístrate gratis como productor mexicano o comprador europeo. Sé parte del lanzamiento oficial el 3 de septiembre de 2026 y conecta directamente sin intermediarios.', keywords: 'registrarse plataforma exportacion, cuenta productor mexico, cuenta comprador europa' },
    en: { title: 'Create Free Account — Global Nexus B2B Mexico–Europe', description: 'Sign up free as a Mexican producer or European buyer. Join our founding members launching September 3, 2026 and connect directly without intermediaries.', keywords: 'sign up export platform, mexican producer account, european buyer account' },
    nl: { title: 'Gratis Account Aanmaken — Global Nexus B2B Mexico–Europa', description: 'Registreer gratis als Mexicaanse producent of Europese koper. Word lid van onze oprichtende leden die lanceren op 3 september 2026.', keywords: 'gratis registreren exportplatform' },
    de: { title: 'Kostenloses Konto Erstellen — Global Nexus B2B Mexiko–Europa', description: 'Registrieren Sie sich kostenlos als mexikanischer Produzent oder europäischer Käufer. Werden Sie Gründungsmitglied mit Launch am 3. September 2026.', keywords: 'kostenlos registrieren exportplattform' },
  },
}
