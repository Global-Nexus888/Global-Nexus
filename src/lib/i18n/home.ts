...
export const homeI18n: Record<Lang, {
  ...
  es: {
    ...
    steps: [
      ...
      { title: 'Exporta sin fricción', desc: 'Logística desde Puerto Veracruz con documentación TLCUEM gestionada por nosotros.' },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      { title: 'Export without friction', desc: 'Logistics from Veracruz Port with TLCUEM documentation managed by us.' },
    ],
  ...
  nl: {
    ...
    steps: [
      ...
      { title: 'Exporteren zonder moeite', desc: 'Logistiek vanuit de haven van Veracruz met TLCUEM-documentatie beheerd door ons.' },
    ],
  ...
  de: {
    ...
    steps: [
      ...
      { title: 'Ohne Aufwand exportieren', desc: 'Logistik vom Hafen Veracruz mit von uns verwalteter TLCUEM-Dokumentation.' },
    ],
